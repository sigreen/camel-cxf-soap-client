...
Things should compile and you should end up with a terminal like this:
...
For creating a sample SOAP request body, I've created a utility bean that creates the SOAP body for me using the code automatically generated by the above plugin.  Here is the code:
...
import net.webservicex.ConversionRate; # object created by wsdl2java
import net.webservicex.Currency; # object created by wsdl2java
...
If the SSL handshake completes successfully, you should receive a reply message with ConversionRateResult=2.222.  And that's it!!  It wasn't really that bad was it?
